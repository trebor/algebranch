...
const RAW_RULES: RawRule[] = [
  ...
  {
    id: 'exponent_self_power',
    name: 'Self-Power to Exponential',
    category: 'Exponent Rules',
    sourcePatternStr: '_A^_A',
    targetPatternStr: 'e^(_A * log(_A))',
    description: 'Rewrites a self-power x^x into the e^(x·ln x) form (requires x > 0).',
  },
  {
    id: 'exponent_self_power_reverse',
    name: 'Exponential to Self-Power',
    category: 'Exponent Rules',
    sourcePatternStr: 'e^(_A * log(_A))',
    targetPatternStr: '_A^_A',
    description: 'Collapses the e^(x·ln x) form back into a self-power x^x.',
  },
  {
    id: 'exponent_radical_product',
    name: 'Radical of a Product',
    category: 'Exponent Rules',
    sourcePatternStr: 'sqrt(_A * _B)',
    targetPatternStr: 'sqrt(_A) * sqrt(_B)',
    description: 'Splits a square root over a product into a product of square roots (non-negative factors).',
  },
  {
    id: 'exponent_radical_product_reverse',
    name: 'Combine Radicals',
    category: 'Exponent Rules',
    sourcePatternStr: 'sqrt(_A) * sqrt(_B)',
    targetPatternStr: 'sqrt(_A * _B)',
    description: 'Combines a product of square roots under a single root.',
  },
  {
    id: 'exponent_sqrt',
  ...
  {
    id: 'repeated_subtraction_2_reverse',
    name: 'Express as Multiplication',
    category: 'Basic Arithmetic',
    sourcePatternStr: '-_A - _A',
    targetPatternStr: '2 * -_A',
    description: 'Combines two identical negative terms into multiplication by 2.',
  },
  {
    id: 'repeated_subtraction_3_reverse',
    name: 'Express as Multiplication',
    category: 'Basic Arithmetic',
    sourcePatternStr: '-_A - _A - _A',
    targetPatternStr: '3 * -_A',
    description: 'Combines three identical negative terms into multiplication by 3.',
  },
  {
    id: 'repeated_subtraction_4_reverse',
    name: 'Express as Multiplication',
    category: 'Basic Arithmetic',
    sourcePatternStr: '-_A - _A - _A - _A',
    targetPatternStr: '4 * -_A',
    description: 'Combines four identical negative terms into multiplication by 4.',
  },
  {
    id: 'repeated_subtraction_5_reverse',
    name: 'Express as Multiplication',
    category: 'Basic Arithmetic',
    sourcePatternStr: '-_A - _A - _A - _A - _A',
    targetPatternStr: '5 * -_A',
    description: 'Combines five identical negative terms into multiplication by 5.',
  },
  {
