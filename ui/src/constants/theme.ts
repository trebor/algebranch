...
export const THEME_GLASS = {
  ...
  SHARE_PILL_PRIMARY: 'flex items-center gap-1.5 py-1.5 pl-3 pr-2.5 sm:pl-3.5 text-xs font-semibold text-white/80 hover:text-white hover:bg-white/10 rounded-l-full transition-colors cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed',
