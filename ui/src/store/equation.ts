...
// ==========================================
// Onboarding Tour Types & State Atoms
// ==========================================
...
export const ONBOARDING_CHAPTERS: OnboardingChapter[] = [
  ...
  },
  {
    ...
    description: 'Learn how to solve equations containing exponents by transposing power operations.',
    initialEquation: 'x ^ 2 - 9 = 0',
    steps: [
      {
        title: 'Isolate the Power',
        description: 'First, let\'s isolate the x^2 term. Click on the highlighted 9 to move it to the other side.',
        highlightPath: 'lhs/1', // constant 9
        nextEquation: 'x ^ 2 = 0 + 9',
        stepLabel: 'Transpose'
      },
      {
        title: 'Simplify Right Side',
        description: 'Simplify the sum 0 + 9 to get 9.',
        highlightPath: 'rhs',
        nextEquation: 'x ^ 2 = 9',
        stepLabel: 'Simplify'
      },
      {
        ...
        description: 'To undo the exponent ^2, we transpose the power. Moving a power operation across the equals sign turns it into a root (sqrt).',
        highlightPath: 'lhs', // power node
      ...
      {
        title: 'Solved!',
        description: 'Perfect! You solved for x. Moving powers across the equals sign turns them into roots.',
        highlightPath: null,
        nextEquation: ''
      }
    ]
  },
  {
    ...
    steps: [
      ...
      {
        title: 'Transpose -9',
        description: 'Now we are back to a familiar shape. Click on the highlighted 9 to move it to the right side.',
        highlightPath: 'lhs/1',
        nextEquation: 'x ^ 2 = 0 + 9',
        stepLabel: 'Transpose'
      },
      {
        title: 'Simplify Right Side',
        description: 'Simplify 0 + 9 to clean up the equation.',
        highlightPath: 'rhs',
        nextEquation: 'x ^ 2 = 9',
        stepLabel: 'Simplify'
      },
      {
        title: 'Root Transposition',
        description: 'Move the power of 2 across the equals sign to turn it into a square root.',
        highlightPath: 'lhs',
        nextEquation: 'x = sqrt(9)',
        stepLabel: 'Transpose'
      },
